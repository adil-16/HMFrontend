      ...
      <div className="m-8">
        ...
        <div className="bg-black border border-white p-2 rounded-xl shadow-md px-3 md:px-8">
          ...
          <div className="flex flex-col">
            <h2 className="font-Nunitoo text-white text-16 sm:text-24 font-medium pt-2 sm:pt-8 pb-2">
              Are you sure you want to delete bank?
            </h2>
            <div className="flex gap-x-2 my-3">
              <button className="bg-white text-orange w-full" onClick={onClose}>
                Cancel
              </button>
              <button
